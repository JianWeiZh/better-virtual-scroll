(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["better-virtual-scroll"] = factory();
	else
		root["better-virtual-scroll"] = factory();
...
// CONCATENATED MODULE: ./src/components/vue-virtual-scroll-list/src/virtual.js
...
var virtual_Virtual = /*#__PURE__*/function () {
  ...
  _createClass(Virtual, [{
    ...
    value: function handleScroll(offset) {
      this.direction = offset < this.offset ? DIRECTION_TYPE.FRONT : DIRECTION_TYPE.BEHIND; // this.offset = offset
    ...
    value: function getPadFront() {
      var list = Array.from(this.sizes).slice(0, this.range.start);
      var num = 0;
    ...
    value: function getPadBehind() {
      ...
      var num = 0;
      var list = Array.from(this.sizes).slice(end, lastIndex);
      list.map(function (item) {
        num += item[1];
      });
      return num;
...
// CONCATENATED MODULE: ./src/components/vue-virtual-scroll-list/src/index.js
...
var src_Vir = /*#__PURE__*/function () {
  function Vir(params) {
    _classCallCheck(this, Vir);
  ...
  _createClass(Vir, [{
    ...
    value: function installVirtual() {
      this.virtual = new virtual_Virtual({
        slotHeaderSize: 0,
        slotFooterSize: 0,
        keeps: this.params.keeps || 20,
        estimateSize: 18,
        buffer: this.params.buffer || 5,
    ...
    key: "updataVirtual",
    value: function updataVirtual(list) {
      this.list = list;
    ...
    value: function setHeight(fn) {
      ...
      for (var i = 0; i < list.length; i++) {
        ...
        (_this$virtual = this.virtual).saveSize.apply(_this$virtual, _toConsumableArray(res));
      }
    }
  }, {
...
/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (src_Vir);
...
//# sourceMappingURL=better-virtual-scroll.umd.js.map